    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator('^\\d{0,9}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_zip', models.CharField(blank=True, max_length=8, null=True, validators=[django.core.validators.RegexValidator('^\\d{0,9}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered_items', models.CharField(blank=True, default='Not Set', max_length=200, null=True)),
