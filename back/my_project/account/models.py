...
class Model(models.Model):
    ...
    user = models.ForeignKey(User, related_name="model", on_delete=models.CASCADE, null=True, blank=True)
    ...
    address_zip = models.CharField(max_length=8, validators=[RegexValidator(r'^\d{0,9}$')], null=True, blank=True)
...
class BillingAddress(models.Model):
    ...
    phone_number = models.CharField(max_length=15, validators=[RegexValidator(r'^\d{0,9}$')] ,null=False, blank=False)
...
class OrderModel(models.Model):
    ...
    ordered_items = models.CharField(max_length=200, null=True, blank=True, default="Not Set")
