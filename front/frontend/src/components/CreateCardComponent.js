...
const CreateCardComponent = ({ Cards, addressSelected }) => {
  ...
  // pay with already existing (saved)  card handler
      ...
      if (cardData.id === cardDetailsId) {
        return (
          <div>
            ...
            <p>
              <b>Exp Month:</b> {cardData.exp_month}
            </p>
            <p>
              <b>Exp Year:</b> {cardData.exp_year}
            </p>
          </div>
        );
      }
          ...
          <Form onSubmit={handleCardSubmittion}>
            ...
            <Row>
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  >
                    <option>-- --</option>
                    {Array.from({ length: 21 }, (x, i) => (
                      <option key={i}>{current_year + i}</option>
                    ))}
                  </select>
                </Form.Group>
              </Col>
            ...
            <Form.Text className="text-muted pb-2">
              <span style={{ display: "flex" }}>
                ...
                />
                <span hidden={differentCard} className="ml-1">
        ...
        {Cards.length > 0
          ? Cards.map((cardData) => (
              <div key={cardData.id}>
                ...
                >
                  <p>
                    <b>Card Number:</b> XXXX XXXX XXXX{" "}
                    {cardData.card_number.slice(12, 18)}
                  </p>
                  <div>
                ...
                <span onClick={() => history("/card-details/")}>
                  <i
                    title="edit card"
